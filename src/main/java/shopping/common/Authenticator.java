...
public class Authenticator {
    ...
    public Authenticator(HttpTransport httpTransport, JsonFactory jsonFactory, Set<String> scopes, Config config)
            throws IOException{
        this.scopes = scopes;
        this.config = config;
    ...
    public Credential authenticate() throws IOException {
        ...
        if (config.getPath() == null) {
            throw new IllegalArgumentException("Must use Application Default Credentials with no configuration directory.");
        }
